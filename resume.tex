...
\begin{itemize}
\item Over ten years experience with the GNU/Linux toolchain.
\item Four years experience with NodeJs.
...
\item\textbf{Database Engines:} MySQL, MSSQL, SQLite, CouchDB
...
\item\textbf{Testing Frameworks:} Sinon, Mocha, Cucumber
\item\textbf{Source Control:} Git, Team Foundation Server
\item\textbf{DevOps Tools:} Docker
