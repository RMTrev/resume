...
\begin{center}
\vspace{0.0625in}
\noindent {Trevor Daniels, 707 W Sheridan Road Apt 430 -- Chicago, IL 60613}
\vspace{0.0625in}
\end{center}
}}}
}
...
\begin{itemize}
\item Ten years experience with the Linux operating system. Able to use the command line and the GNU/Linux toolchain to manage a server.
...
\begin{itemize}
\item\textbf{Languages:} C/C++, C\#, Python, Java, J2EE, LISP, HTML5, CSS3, Javascript, Typescript
\item\textbf{Database Engines:} MySQL, MSSQL, SQLite, CouchDB
\item\textbf{Development Environments:} Visual Studio, Eclipse, Android SDK, Emacs, WebStorm
\item\textbf{Frameworks:} Angular, Vue, .NET, Django, jQuery, Dojo, LESS, WPF
...
\textit{Junior Software Engineer $\to$ Senior Software Engineer I}, August, 2016 -- Current
\begin{itemize}
\item Developed custom web applications for clients, using technologies such as Angular, Vue and NodeJS in an Agile team.
\item Used the Contentful CMS to rapidly construct a website for a client.
\item Enforced a very high standard of quality in the codebases I helped maintain through unit tests, component tests, C2E tests, and code reviews.
